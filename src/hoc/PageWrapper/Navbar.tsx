  ...
  return (
    <>
      ...
      <Link to={PATHS.PRODUCTS.add}>
        <button className="h-10 whitespace-nowrap rounded-full bg-primary-50 px-6 text-primary-950 hover:bg-primary-100 focus:border focus:border-primary-950 focus:bg-primary-100 active:bg-primary-300 active:shadow-[inset_0_0_4px_2px_#ABC2F6]">
          Створити оголошення
        </button>
      </Link>
      <Link to="#">
